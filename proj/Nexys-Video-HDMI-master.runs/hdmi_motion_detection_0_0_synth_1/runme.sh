...
HD_PWD='C:/Users/Tristan/Documents/Nexys-Video-HDMI-master/proj/Nexys-Video-HDMI-master.runs/hdmi_motion_detection_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_motion_detection_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_motion_detection_0_0.tcl
