...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state5) & ((exitcond7_i_fu_316_p2 == 1'd1) | (p_read_1_read_fu_112_p2 == 1'd0)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond8_i_fu_327_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((p_read_1_read_fu_112_p2 == 1'd1) & (exitcond7_i_fu_316_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_i_114_reg_398 <= grp_reg_unsigned_short_s_fu_301_ap_return;
        tmp_i_reg_393 <= grp_reg_unsigned_short_s_fu_295_ap_return;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & ((exitcond7_i_fu_316_p2 == 1'd1) | (p_read_1_read_fu_112_p2 == 1'd0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op66_read_state7 == 1'b1)) | ((exitcond8_i_reg_432 == 1'd0) & (srcLayer0_V_val_0_V1_status == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op66_read_state7 == 1'b1)) | ((exitcond8_i_reg_432 == 1'd0) & (srcLayer0_V_val_0_V1_status == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op66_read_state7 == 1'b1)) | ((exitcond8_i_reg_432 == 1'd0) & (srcLayer0_V_val_0_V1_status == 1'b0))));
end
...
always @ (*) begin
    ap_block_state7_pp1_stage0_iter1 = (((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op66_read_state7 == 1'b1)) | ((exitcond8_i_reg_432 == 1'd0) & (srcLayer0_V_val_0_V1_status == 1'b0)));
end
...
assign exitcond8_i_fu_327_p2 = ((j_i_reg_192 == tmp_i_114_reg_398) ? 1'b1 : 1'b0);
