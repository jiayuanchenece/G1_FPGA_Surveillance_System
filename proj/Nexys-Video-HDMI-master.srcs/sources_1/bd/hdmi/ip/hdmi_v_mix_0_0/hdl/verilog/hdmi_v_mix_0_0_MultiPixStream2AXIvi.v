...
module hdmi_v_mix_0_0_MultiPixStream2AXIvi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond6_fu_295_p2;
wire    ap_CS_fsm_state5;
reg    ap_block_state5;
wire   [15:0] i_2_fu_300_p2;
reg   [15:0] i_2_reg_478;
wire   [0:0] exitcond7_fu_310_p2;
...
wire   [7:0] tmp_5_fu_364_p5;
wire   [7:0] tmp_4_fu_353_p5;
wire   [7:0] tmp_3_fu_342_p5;
reg   [6:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
hdmi_v_mix_0_0_MultiPixStream2AXcud #(
    .DataWidth( 2 ),
    .AddressRange( 3 ),
    .AddressWidth( 2 ))
mapComp_0_U(
...
hdmi_v_mix_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_212(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hdmi_v_mix_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_218(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hdmi_v_mix_0_0_v_mix_mux_32_8_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 8 ),
...
hdmi_v_mix_0_0_v_mix_mux_32_8_1_1 #(
    ...
    .din3_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
v_mix_mux_32_8_1_1_U190(
    .din0(StrmMPix_V_val_0_V_dout),
    .din1(StrmMPix_V_val_1_V_dout),
    .din2(StrmMPix_V_val_2_V_dout),
    .din3(tmp_8_reg_464),
    .dout(tmp_4_fu_353_p5)
);
...
hdmi_v_mix_0_0_v_mix_mux_32_8_1_1 #(
    ...
    .din3_WIDTH( 2 ),
    .dout_WIDTH( 8 ))
v_mix_mux_32_8_1_1_U191(
    .din0(StrmMPix_V_val_0_V_dout),
    .din1(StrmMPix_V_val_1_V_dout),
    .din2(StrmMPix_V_val_2_V_dout),
    .din3(tmp_9_reg_469),
    .dout(tmp_5_fu_364_p5)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state6) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond6_fu_295_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((exitcond5_fu_228_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        i1_reg_190 <= 16'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond6_fu_295_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        j_reg_201 <= 16'd0;
    end else if (((exitcond7_fu_310_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_reg_201 <= j_1_fu_315_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond7_reg_483 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond7_reg_483 <= exitcond7_fu_310_p2;
        exitcond7_reg_483_pp0_iter1_reg <= exitcond7_reg_483;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond5_fu_228_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond7_fu_310_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond7_reg_483 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((exitcond7_fu_310_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((exitcond7_reg_483_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond7_reg_483 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond7_fu_310_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond7_fu_310_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond7_reg_483 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state8_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state7_io) | ((exitcond7_reg_483 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state8_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state7_io) | ((exitcond7_reg_483 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status)))));
end
...
always @ (*) begin
    ap_block_state7_io = ((exitcond7_reg_483 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state7_pp0_stage0_iter1 = ((exitcond7_reg_483 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status));
end

always @ (*) begin
    ap_block_state8_io = ((exitcond7_reg_483_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign exitcond5_fu_228_p2 = ((i_reg_178 == 2'd3) ? 1'b1 : 1'b0);

assign exitcond6_fu_295_p2 = ((i1_reg_190 == tmp_reg_419) ? 1'b1 : 1'b0);

assign exitcond7_fu_310_p2 = ((j_reg_201 == tmp_s_reg_424) ? 1'b1 : 1'b0);
...
assign tmp_data_V_fu_375_p4 = {{{tmp_5_fu_364_p5}, {tmp_4_fu_353_p5}}, {tmp_3_fu_342_p5}};
...
endmodule //hdmi_v_mix_0_0_MultiPixStream2AXIvi
