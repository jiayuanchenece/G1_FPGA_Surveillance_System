...
HD_PWD='C:/Users/Tristan/Documents/Nexys-Video-HDMI-master/proj/Nexys-Video-HDMI-master.runs/bd_e87d_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_e87d_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_e87d_mac_0.tcl
